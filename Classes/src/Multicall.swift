...
public struct Multicall {
    private let client: XinfinClientProtocol

    public init(client: XinfinClientProtocol) {
        self.client = client
    }
...
extension Multicall {
    ...
    public struct Call: ABITuple {
        public static var types: [ABIType.Type] = [XinfinAddress.self, Data.self]
        public var encodableValues: [ABIType] { [target, encodedFunction] }

        public let target: XinfinAddress
