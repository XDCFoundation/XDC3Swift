...
public struct XinfinBlockInfo: Equatable {
    public var number: XinfinBlock
    public var timestamp: Date
    public var transactions: [String]
}

extension XinfinBlockInfo: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        guard let number = try? container.decode(XinfinBlock.self, forKey: .number) else {
